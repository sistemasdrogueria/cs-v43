 ...
 *
 */
class LocalidadsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_localidads_pro' => ['type' => 'foreign', 'columns' => ['provincia_id'], 'references' => ['provincias', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
