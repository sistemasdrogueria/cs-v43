...
class PuntosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cantidad_disponible' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'modificado' => '2017-06-16 13:35:52'
        ],
    ];
}
