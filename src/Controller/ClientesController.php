...
class ClientesController extends AppController
{
    ...
    {
        if (in_array($this->request->getParam('action'), ['index', 'view', 'editAdmin', 'indexAdmin', 'deleteAdmin', 'indexSearchAdmin'])) {


            $tiene = $this->tienepermiso('users', $this->request->getParam('action'), $this->request->getSession()->read('Auth.role'));
            if (!$tiene)
