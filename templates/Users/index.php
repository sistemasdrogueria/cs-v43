    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('notificacion') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Number->format($user->perfile_id) ?></td>
                <td><?= $this->Number->format($user->notificacion) ?></td>
                <td><?= $this->Number->format($user->super) ?></td>
                <td class="actions">
