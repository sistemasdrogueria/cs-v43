...
<?= $this->Form->control('role', ['value'=>'client','type'=>'hidden']);	?>
	...
	<!-- div class="form-group">
		...
		<div class="col-md-9 col-sm-9 col-xs-12">
		  <?php	//echo $this->Form->control('username',[ 'class'=>'form-control col-md-7 col-xs-12']);?>
		</div>
	 </div -->
	<div class="form-group">
	  ...
	  <div class="form-group">
		...
		<div class="col-md-9 col-sm-9 col-xs-12">
			...
			<?php echo $this->Form->password('password_confirm',['class'=>'form-control'] );?>
