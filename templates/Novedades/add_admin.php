...
<?= $this->Form->create($novedade,['url'=>['controller'=>'Novedades','action'=>'add_admin'],'type' => 'file','class'=>'form-horizontal form-label-left']) ?>
	   ...
	   <div class="form-group">
		...
		<div class="col-md-2 col-sm-2 col-xs-12">      
                        <div class='input-group date' id='fecha'>
						 <?= $this->Form->control('fecha', ['type'=>'text','label'=>'', 
								   'class'=>'form-control', 
								   ]);?>
